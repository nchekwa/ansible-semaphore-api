...
class Template(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "project_id", "inventory_id", "repository_id", "environment_id", "view_id", "name", "playbook", "arguments", "description", "allow_override_args_in_task", "suppress_success_alerts", "app"]
